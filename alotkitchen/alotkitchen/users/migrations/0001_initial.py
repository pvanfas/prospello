    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("enc_key", models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                (
                    "usertype",
                    models.CharField(
                        choices=[
                ...
                (
                    "preferred_language",
                    models.CharField(
                        choices=[("en", "English"), ("ml", "Malayalam"), ("ar", "Arabic"), ("hi", "Hindi"), ("ta", "Tamil"), ("te", "Telugu")],
                        default="en",
                        max_length=10,
                        verbose_name="Language for verbal communication",
                    ),
                ),
