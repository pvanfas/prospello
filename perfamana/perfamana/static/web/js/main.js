    ...
    function ms_theme_mode() {
        if ($.exists('.ms_theme_mode')) {
            ...
            function updateUITheme() {
                ...
                // If no theme is set in localStorage, set a default theme
                if (!currentTheme) {
                    currentTheme = 'light'; // Change 'light' to 'dark' if you want dark mode as default
            ...
            // Hide content until theme mode is applied
            $('body').css('visibility', 'hidden');

            // Ensure a theme is set on first load
            updateUITheme();

            // Show content after applying the theme
